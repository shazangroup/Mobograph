package finalsoft.users.backend;
...
import finalsoft.users.database.Change;
import finalsoft.users.database.changesDBAdapter;
import finalsoft.users.database.user;
