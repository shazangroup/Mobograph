            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, final int i, long l) {
                    ...
                    if (i == headerColorRow) {
                        ...
                        },themePrefs.getInt("contactsHeaderColor", 0x00000000), CENTER, 0, false);
                        colorDialog.show();
                        ...
                        },themePrefs.getInt("contactsHeaderGradientColor",0x00000000), CENTER, 0, true);
                        colorDialog.show();
    ...
    private class ListAdapter extends BaseFragmentAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (type == 0) {
                ...
                if (i == headerColorRow) {
                    textCell.setTextAndColor(LocaleController.getString("HeaderColor", R.string.HeaderColor), themePrefs.getInt("contactsHeaderColor", 0x00000000), false);
                } else if (i == headerGradientColorRow) {
                    textCell.setTextAndColor(LocaleController.getString("RowGradientColor", R.string.RowGradientColor), themePrefs.getInt("contactsHeaderGradient", 0) == 0 ? 0x00000000 : themePrefs.getInt("contactsHeaderGradientColor", 0x00000000), true);
                } else if (i == headerTitleColorRow) {
