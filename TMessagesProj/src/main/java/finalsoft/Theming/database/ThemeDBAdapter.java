package finalsoft.Theming.database;
...
import finalsoft.Theming.online.theme;
...
public class ThemeDBAdapter {
    ...
    private static final String DATABASE_NAME = "JetGram5";
    ...
    private static final String TAG = "JetGram_USER_TABLE_THEMES";
...
//            Log.i("finalsoft","DatabaseHelper onCreate");
            try {
    ...
    public ThemeDBAdapter(Context ctx) {
        yek_SH_flashkart = new String[]{KEY_ID,KEY_NAME , KEY_DESCRIPTION , KEY_THUMB1,KEY_THUMB2 , KEY_THUMB3 , KEY_XMLLINK ,KEY_IMGELINK, KEY_XMLDATA};
       DBHelper = new ThemeDBAdapter.DatabaseHelper(ctx);
    }
