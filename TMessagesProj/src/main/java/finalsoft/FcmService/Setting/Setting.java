...
public class Setting {
    ...
    public static void setPushMode(boolean status){
        setupSetting();
        editor.putBoolean("PushMode", status);
        editor.commit();
    }
    public static boolean getPushMode() {
        setupSetting();
        return pref.getBoolean("PushMode", false);
    }

    public static void setMuteMode(boolean status){
        setupSetting();
        editor.putBoolean("MuteMode", status);
        editor.commit();
    }
    public static boolean getMuteMode() {
        setupSetting();
        return pref.getBoolean("MuteMode", false);
    }
    public static void setHideMode(boolean status){
        setupSetting();
    ...
    public static boolean getHideMode() {
        setupSetting();
        return pref.getBoolean("HideMode", false);
    }
}
