...
public class AndroidUtilities {
    ...
    public static final int defColor =0xFF4c95f8;// 0xFF02708A;//0xff42A5F5;//0xff58BCD5;//0xff43C3DB;//0xff2f8cc9;58BCD5//0xff55abd2
...
//        Log.i("qqqqq","key:"+key +" color:" +themePrefs.getInt(key, defColor));
...
/*    public static int getIntTColor(String key) {
    ...
    public static int getIntDarkerColor(String key, int factor) {
        SharedPreferences themePrefs = ApplicationLoader.applicationContext.getSharedPreferences(THEME_PREFS, THEME_PREFS_MODE);
        int color = themePrefs.getInt(key, 0xFFffffff);
//        Log.i("qqqqq","key:"+key +" color:" + color +" factor:"+factor);
