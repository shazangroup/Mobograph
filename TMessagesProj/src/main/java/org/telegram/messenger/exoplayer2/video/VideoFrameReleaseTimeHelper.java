...
//        Log.i("finalsoft","trrrrrrrrrrrrrrrr");
...
//        Log.i("finalsoft","trrrrrrrrrrrrrrrr2");
...
//            Log.i("finalsoft","CREATE_CHOREOGRAPHER");
...
//        Log.i("finalsoft","CREATE_CHOREOGRAPHER3");
    ...
    private void addObserverInternal() {
      observerCount++;
      if (observerCount == 1) {
//          Log.i("finalsoft","CREATE_CHOREOGRAPHER2");
    ...
    private void removeObserverInternal() {
      observerCount--;
      if (observerCount == 0) {
//          Log.i("finalsoft","CREATE_CHOREOGRAPHER1");
